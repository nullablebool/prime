...
{
    public class NetworkPairVolume
    {
        ...
        public NetworkPairVolume Reversed()
        {
            return new NetworkPairVolume(Network, Pair.Reversed, Volume24Quote, Volume24Base);
        }
    }
}